...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def otimizar(self):
        ...
        self.ui.mostrar_custo.append('R$' + str(melhor_intervalo['best_result']))
        #print('O melhor intervalor é',melhor_intervalo['x_best'],'com um valor de R$', melhor_intervalo['best_result'])
